...
function Appointment({ onModalClose }: { onModalClose: () => void }) {
    ...
    <dialog ref={modalRef} onClose={onModalClose}>
      ...
      <div className="fixed inset-0 z-10 w-screen sm:w-1/2 mx-auto overflow-y-auto">
        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          <div className="flex flex-col gap-6 w-full mx-auto text-center text-black bg-white shadow-lg">
            <div className="bg-blush h-16 flex items-center justify-center p-10">
